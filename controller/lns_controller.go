...
// MilkFat
func GetAllLnsMilkFat(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
...
func GetLnsMilkFatByDeviceId(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
...
// GPS
func GetAllLnsGPS(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
...
func GetLnsGPSByDeviceId(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
...
// VibrationAverage
func GetAllLnsVibrationAverage(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
	...
	for iterator.Next() { // Iterate over query response
		...
		obj := gin.H{
			"fields": gin.H{
				"temperature":       value["temperature"],
				"humidity":          value["humidity"],
				"vibrationAverageX": value["VibrationAverageX"],
				"vibrationAverageY": value["VibrationAverageY"],
				"vibrationAverageZ": value["VibrationAverageZ"],
				"boardVoltage":      value["boardVoltage"],
				"data":              value["data"],
				"fCnt":              value["fCnt"],
				"fPort":             value["fPort"],
...
func GetLnsVibrationAverageByDeviceId(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
...
// Temperature8Point
func GetAllLnsTemperature8Point(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
	...
	for iterator.Next() { // Iterate over query response
		...
		obj := gin.H{
			"fields": gin.H{
				...
				"temperature3":   value["temperature3"],
				"temperature4":   value["temperature4"],
				"temperature5":   value["temperature5"],
				"temperature6":   value["temperature6"],
				"temperature7":   value["temperature7"],
				"temperature8":   value["temperature8"],
				"boardVoltage":   value["boardVoltage"],
				"data":           value["data"],
				"fCnt":           value["fCnt"],
				"fPort":          value["fPort"],
...
func GetLnsTemperature8PointByDeviceId(c *gin.Context) {
	intervalStr := c.Query("interval")
	interval, err := strconv.Atoi(intervalStr)
